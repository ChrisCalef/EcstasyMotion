...
//-----------------------------------------------------------------------------
// Pistol launcher weapon. This file contains all the items related to this weapon
...
datablock SFXProfile(PistolReloadSound)
{
...
datablock SFXProfile(PistolFireSound)
{
filename = "art/sound/weapons/pistol_fire";
description = AudioClose3d;
preload = true;
};

datablock SFXProfile(PistolFireEmptySound)
{
...
//-----------------------------------------------------------------------------
// Pistol Launcher projectile particles

datablock ParticleData(PistolParticle)
{
...
datablock ParticleEmitterData(PistolEmitter)
{
   ejectionPeriodMS = 10;
   periodVarianceMS = 2;
   ejectionVelocity = 2;
...
datablock ExplosionData(PistolSubExplosion1)
{
   offset = 1;
...
datablock ExplosionData(PistolSubExplosion2)
{
   offset = 2;
...
datablock ExplosionData(RocketExplosion)
{
   ...
   subExplosion[0] = PistolSubExplosion1;
   subExplosion[1] = PistolSubExplosion2;
...
datablock DebrisData(PistolShell)
{
   //shapeFile = "art/shapes/weapons/swarmgun/debris.dts";
   lifetime = 6.0;
   minSpinSpeed = 300.0;
   maxSpinSpeed = 400.0;
   elasticity = 0.65;
...
{
   projectileShapeName = "art/shapes/weapons/pistols/MPP_b.dts";
   directDamage        = 20;
   radiusDamage        = 20;
   damageRadius        = 5;
   areaImpulse         = 2000;
   ...
   particleEmitter     = PistolEmitter;

   muzzleVelocity      = 300;//100;
   velInheritFactor    = 1;
...
{
   //Ecstasy Motion: removing all this in favor of physics impulse force.
   //// Apply damage to the object all shape base objects
   //if (%col.getType() & $TypeMasks::ShapeBaseObjectType)
      //%col.damage(%obj,%pos,%this.directDamage,"PistolBullet");
   //
   ...
   //radiusDamage(%obj, %pos, %this.damageRadius, %this.radiusDamage, "PistolBullet", %this.areaImpulse);
}
...
datablock ItemData(PistolAmmo)
{
   ...
   shapeFile = "art/shapes/weapons/pistols/MPP_a.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;

	// Dynamic properties defined by the scripts
	pickUpName = "Pistol launcher ammo";
   maxInventory = 50;
};
...
datablock ItemData(Pistol)
{
   ...
   emap = true;
	...
	// Dynamic properties defined by the scripts
	pickUpName = "a Pistol_launcher";
	image = PistolImage;
};


//--------------------------------------------------------------------------
// Pistol Launcher image which does all the work.  Images do not normally exist in
...
datablock ShapeBaseImageData(PistolImage)
{
   ...
   //stateEmitter[3]                  = PistolFireEmitter;
