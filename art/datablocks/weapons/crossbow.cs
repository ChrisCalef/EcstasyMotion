...
{
//filename = "art/sound/relbow_mono_01";
filename = "art/sound/soccer_kick_01";
description = AudioClose3d;
preload = true;
};
...
{
filename = "art/sound/soccer_kick_02";
description = AudioClose3d;
preload = true;
};
...
datablock ItemData(Crossbow)
{
   ...
   shapeFile = "art/shapes/weapons/BallShooter/shell.dts";
