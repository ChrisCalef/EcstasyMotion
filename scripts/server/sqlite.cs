...
function sqliteTest(%dbname)
{
   ...
   %query = "INSERT INTO users (username) VALUES ('Chris')";
   %result = sqlite.query(%query, 0);
   %query = "INSERT INTO users (uername) VALUES ('Jondo')";
   %result = sqlite.query(%query, 0);
   %query = "INSERT INTO users (username) VALUES ('Ari')";
   %result = sqlite.query(%query, 0);
   %query = "INSERT INTO users (username) VALUES ('Rex')";
   %result = sqlite.query(%query, 0);
   %query = "INSERT INTO users (username) VALUES ('Mo')";
   %result = sqlite.query(%query, 0);
   if (%result == 0)
   {
      // query failed
