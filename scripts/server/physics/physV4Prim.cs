...
{
 shapeFile	= "art/shapes/Daz3D/v4_ranger/v4_ranger_phys.dts";
 category				= "Actors";
 DynamicFriction = 0.6;
 StaticFriction	 = 0.6;
 Restitution	     = 0.1;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone1)
{
 BaseNode = "Bone1";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone2)
{
 BaseNode = "Bone2";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone3)
{
 BaseNode = "Bone3";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone4)
{
 BaseNode = "Bone4";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone5)
{
 BaseNode = "Bone5";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone6)
{
 BaseNode = "Bone6";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone7)
{
 BaseNode = "Bone7";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone8)
{
 BaseNode = "Bone8";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone9)
{
 BaseNode = "Bone9";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone10)
{
 BaseNode = "Bone10";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone11)
{
 BaseNode = "Bone11";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
...
datablock fxFlexBodyPartData(V4_Ranger_Bone12)
{
 BaseNode = "Bone12";
 FlexBodyData	= V4_Ranger;
 JointData  = Human_Right_Ankle_Joint;
