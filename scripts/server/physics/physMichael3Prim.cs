...
datablock fxFlexBodyData(M3_DesertSoldier)
{
 shapeFile	= "art/shapes/Daz3D/Michael3/M3_DesertSoldier.dts";
 category				= "Actors";
 DynamicFriction = 0.6;
 StaticFriction	 = 0.6;
 Restitution	     = 0.1;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_Hip)
{
 BaseNode = "hip";
 ChildNode = "abdomen";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_Abdomen)
{
 BaseNode = "abdomen";
 ChildNode = "chest";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_Chest)
{
 BaseNode = "chest";
 ChildNode = "neck";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_Neck)
{
 BaseNode = "neck";
 ChildNode = "head";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_Head)
{
 BaseNode = "head";
 FlexBodyData	= M3_DesertSoldier;
 TorqueMin = "-150 -150 -50";
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Collar)
{
 BaseNode = "lCollar";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Shoulder)
{
 BaseNode = "lShldr";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Forearm)
{
 BaseNode = "lForeArm";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Hand)
{
 BaseNode = "lHand";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Collar)
{
 BaseNode = "rCollar";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Shoulder)
{
 BaseNode = "rShldr";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Forearm)
{
 BaseNode = "rForeArm";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Hand)
{
   BaseNode = "rHand";
   FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Thigh)
{
 BaseNode = "lThigh";
 ParentNode = "lButtock";
 ChildNode = "lShin";
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Shin)
{
 BaseNode = "lShin";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_L_Foot)
{
 BaseNode = "lFoot";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Thigh)
{
 BaseNode = "rThigh";
 ParentNode = "rButtock";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Shin)
{
 BaseNode = "rShin";
 FlexBodyData	= M3_DesertSoldier;
...
datablock fxFlexBodyPartData(M3_DesertSoldier_R_Foot)
{
 BaseNode = "rFoot";
 FlexBodyData	= M3_DesertSoldier;
...
function makeSoccerMale(%spawnPoint,%angle)
{
   ...
   $nude_male = new (fxFlexBody)() {
      dataBlock        = M3_DesertSoldier;
      position         = %curPos;
      rotation         = %angle;//"0 0 1 " @ %angle;    
   };
   MissionCleanup.add($M3_DesertSoldier);
   $M3_DesertSoldier.schedule(20,"setPhysActive",1);
   $M3_DesertSoldier.setIsRendering(1);
   //$male.playThread(0,"idle");
   //if (%running) $male.startAnimating(1);
   //$male.headUp();
   return $M3_DesertSoldier;
}
