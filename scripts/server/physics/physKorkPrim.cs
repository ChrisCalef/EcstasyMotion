...
datablock gaFitnessData(korkBodyUp)
{
   BodypartName = "Bip01 Pelvis";
   PositionGoal = "-0.2 -0.2 1.0";
   PositionGoalType = "1 1 0";
   RotationGoal = 0.0;
   RotationGoalType = 0;   
};
...
datablock fxFlexBodyPartData(Kork_Spine1)
{
 ...
 JointData  = Kork_Spine_Joint;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.149188 0.14 0.14"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.074594 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_Spine2)
{
 ...
 //FarVerts = -10;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.2098667 0.14 0.14"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.10493335 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_L_Clavicle)
{
 ...
 //FarVerts = -30;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.358891 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.1794455 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_L_UpperArm)
{
 ...
 //WeightThreshold = 0.5;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.395474 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.197737 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_L_Forearm)
{
 ...
 //FarVerts = -20;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.363508 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.181754 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
 //Dimensions = "0.1 0 0.2";
 //Orientation = "0.0 0.0 90.0";
 //Offset = "0.2 0.0 0.0"; 
...
datablock fxFlexBodyPartData(Kork_L_Hand)
{
 ...
 //TorqueMax = "300 300 0";
 ShapeType = SHAPE_BOX;
 Dimensions = "0.1982797 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.09913985 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_L_Thigh)
{
 ...
 //FarVerts = -5;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.5677639 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.28388195 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_L_Calf)
{
 ...
 //WeightThreshold = 0.5;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.659264 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.329632 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
 //Dimensions = "0.15 0 0.3";
 //Orientation = "0.0 0.0 90.0";
 //Offset = "0.2 0.0 0.0";  
...
datablock fxFlexBodyPartData(Kork_L_Foot)
{
 ...
 //WeightThreshold = 0.5;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.4 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.2 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
...
datablock fxFlexBodyPartData(Kork_R_Calf)
{
 ...
 //WeightThreshold = 0.5;
 ShapeType = SHAPE_BOX;
 Dimensions = "0.6592639 0.05 0.05"; // BOX
 Orientation = "0.0 0.0 0.0"; // BOX
 Offset = "0.32963195 0.0 0.0"; // BOX
 //ShapeType = SHAPE_CAPSULE;
 //Dimensions = "0.15 0 0.3";
 //Orientation = "0.0 0.0 90.0";
 //Offset = "0.2 0.0 0.0"; 
