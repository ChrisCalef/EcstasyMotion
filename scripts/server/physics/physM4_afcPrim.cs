...
datablock fxFlexBodyData(M4_afc)
{
 shapeFile	= "art/shapes/Daz3D/M4_afc/M4_afc.dts";
 category				= "Actors";
 DynamicFriction = 0.6;
 StaticFriction	 = 0.6;
 Restitution	     = 0.1;
...
datablock fxFlexBodyPartData(M4_afc_Hip)
{
 BaseNode = "hip";
 ChildNode = "abdomen";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_Abdomen)
{
 BaseNode = "abdomen";
 ChildNode = "chest";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_Chest)
{
 BaseNode = "chest";
 ChildNode = "neck";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_Neck)
{
 BaseNode = "neck";
 ChildNode = "head";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_Head)
{
 BaseNode = "head";
 FlexBodyData	= M4_afc;
 TorqueMin = "-150 -150 -50";
...
datablock fxFlexBodyPartData(M4_afc_L_Collar)
{
 BaseNode = "lCollar";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_L_Shoulder)
{
 BaseNode = "lShldr";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_L_Forearm)
{
 BaseNode = "lForeArm";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_L_Hand)
{
 BaseNode = "lHand";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Collar)
{
 BaseNode = "rCollar";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Shoulder)
{
 BaseNode = "rShldr";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Forearm)
{
 BaseNode = "rForeArm";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Hand)
{
 BaseNode = "rHand";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_L_Thigh)
{
 BaseNode = "lThigh";
 ParentNode = "lButtock";
 ChildNode = "lShin";
...
datablock fxFlexBodyPartData(M4_afc_L_Shin)
{
 BaseNode = "lShin";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_L_Foot)
{
 BaseNode = "lFoot";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Thigh)
{
 BaseNode = "rThigh";
 ParentNode = "rButtock";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Shin)
{
 BaseNode = "rShin";
 FlexBodyData	= M4_afc;
...
datablock fxFlexBodyPartData(M4_afc_R_Foot)
{
 BaseNode = "rFoot";
 FlexBodyData	= M4_afc;
...
function makeAFCMale(%spawnPoint,%angle)
{
   %curPos = %spawnPoint;
   echo("making a M4_afc!" @ %curPos);
   ...
   MissionCleanup.add($M4_afc);
   $M4_afc.schedule(20,"setPhysActive",1);
   $M4_afc.setIsRendering(1);
