...
datablock fxFlexBodyData(Human_Male_Advanced)
{
 shapeFile	= "art/shapes/ACK/male/advanced.dts";
   category				= "Actors";
 DynamicFriction = 0.6;
 StaticFriction	 = 0.6;
 Restitution	     = 0.1;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_Hip)
{
 BaseNode = "hip";
 ChildNode = "abdomen";
 FlexBodyData	= Human_Male_Advanced;
 //WeightThreshold = 0.5;
 ShapeType = SHAPE_CONVEX;
 Dimensions = "0.15 0 0.05";
 Orientation = "0.0 0 0";
 PlayerData = AdvancedMaleBot;
 //MeshObject = "base_abdomen_one";
};

datablock fxFlexBodyPartData(Human_Male_Advanced_Abdomen)
{
 BaseNode = "abdomen";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_Chest)
{
 BaseNode = "chest";
 ChildNode = "head";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_Neck)
{
 BaseNode = "neck";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_Head)
{
 BaseNode = "head";
 FlexBodyData	= Human_Male_Advanced;
 TorqueMin = "-150 -150 -50";
...
//datablock fxFlexBodyPartData(Human_Male_Advanced_R_Collar)
//{
 //BaseNode = "rCollar";
 //FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_R_Shoulder)
{
 BaseNode = "rShldr";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_R_Forearm)
{
 BaseNode = "rForeArm";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_R_Hand)
{
 BaseNode = "rHand";
 FlexBodyData	= Human_Male_Advanced;
...
//datablock fxFlexBodyPartData(Human_Male_Advanced_L_Collar)
//{
 //BaseNode = "lCollar";
 //FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_L_Shoulder)
{
 BaseNode = "lShldr";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_L_Forearm)
{
 BaseNode = "lForeArm";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_L_Hand)
{
 BaseNode = "lHand";
 FlexBodyData	= Human_Male_Advanced;
 JointData  = Human_Wrist_Joint;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_R_Thigh)
{
 BaseNode = "rThigh";
 ParentNode = "";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_R_Shin)
{
 BaseNode = "rShin";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_R_Foot)
{
 BaseNode = "rFoot";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_L_Thigh)
{
 BaseNode = "lThigh";
...
datablock fxFlexBodyPartData(Human_Male_Advanced_L_Shin)
{
 BaseNode = "lShin";
 FlexBodyData	= Human_Male_Advanced;
...
datablock fxFlexBodyPartData(Human_Male_Advanced_L_Foot)
{
 BaseNode = "lFoot";
 FlexBodyData	= Human_Male_Advanced;
...
function makeHumanMaleAdvanced(%spawnPoint,%angle)
{
   %curPos = %spawnPoint;
   echo("making a Male!" @ %curPos);
   
   $advanced_male = new (fxFlexBody)() {
      dataBlock        = Human_Male_Advanced;
      position  = %curPos;
      rotation         = "0 0 1 " @ %angle;    
   };
   MissionCleanup.add($advanced_male);
   PlayerGetNaked($advanced_male);
   $advanced_male.schedule(100,"setPhysActive",1);
